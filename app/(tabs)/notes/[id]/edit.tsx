      ...
      >
        ...
        >
          ...
          <TextInput
            style={[
              styles.input,
              form.errores.titulo ? styles.inputError : null,
            ]}
            placeholder="Título"
          ...
          />
          {form.errores.titulo ? (
            <Text style={styles.errorLabel}>{form.errores.titulo}</Text>
          ) : null}
          ...
          <TextInput
            style={[
              ...
              form.errores.contenido ? styles.inputError : null,
            ]}
            ...
            numberOfLines={6}
          />
          {form.errores.contenido ? (
            <Text style={styles.errorLabel}>{form.errores.contenido}</Text>
          ) : null}
