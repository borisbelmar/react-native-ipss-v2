...
import { createNotaSchema, updateNotaSchema, type CreateNotaInput, type UpdateNotaInput } from "../schemas/nota.schema"
...
export const useNotaForm = ({ mode, defaultValues, onSubmit }: Props) => {
  ...
  return { titulo, setTitulo, contenido, setContenido, errores, submitting, handleSubmit }
}
